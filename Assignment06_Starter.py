...
# SQuesada,1.1.2030,Fixed bug by clearing the list before it was refilled
...
def choice_2 (lstTable):
    ...
    return strTask, strPriority, dicRow, lstTable

def choice_3 (lstTable,):
